...
namespace nl.xr_lab.toolkit_greybox.Interactions
{
    public class VRButton : MonoBehaviour
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            {
                // if Player hits trigger with any object thta has the "Player" tag, the button will be triggered.
                TriggerButton();
            }
        }
        ...
        private IEnumerator ButtonAnimation()
        {
            ...
            transform.localPosition = new Vector3(0.0f, _pressDepth, 0.0f);
            yield return new WaitForSeconds(_pressDuration);

            // Resets button and bool to be activated again.
            transform.localPosition = new Vector3(0.0f, _restHeight, 0.0f);
            _isPressed = false;
        }
    }
}
